...
<div class="container custom-container table-responsive">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card custom-card">
                <div class="card-body">
    <h1 class="mb-5">Edit Dokumentasi Moment Kelas</h1>
    ...
    <input class="form-control mb-3 mt-1 custom-input" type="file" name="image" id="" >
    <p>file sebelumnya : <strong>{{ $moment->image }}</strong></p>

    <button class="btn btn-submit" type="submit">Simpan</button>
    <a href="{{ route('moment.index') }}" class="btn btn-back">Kembali</a>
    </form>
