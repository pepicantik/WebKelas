                    ...
                    <div class="card-body">
                        <div class="align-items-center justify-content-center">
                            ...
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <input class="form-control mt-2 mb-3 custom-input" type="text" name="username"
                                    id="" placeholder="Masukkan Username Anda" required>

                                <label>Password</label>
                                <input class="form-control mt-2 mb-3 custom-input" type="password" name="password"
                                    id="" placeholder="Masukkan Password Anda" required>
